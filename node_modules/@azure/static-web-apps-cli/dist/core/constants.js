...
export const CUSTOM_AUTH_TOKEN_ENDPOINT_MAPPING = {
    google: {
...
export const CUSTOM_AUTH_USER_ENDPOINT_MAPPING = {
    google: {
...
export const CUSTOM_AUTH_ISS_MAPPING = {
...
export const CUSTOM_AUTH_REQUIRED_FIELDS = {
