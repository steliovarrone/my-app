...
export const normalizeAuthProvider = function (providerName) {
    if (providerName === ENTRAID_FULL_NAME) {
        return "aad";
    }
    return providerName?.toLowerCase() || "";
};
export const checkCustomAuthConfigFields = function (context, providerName, customAuth) {
    const generateResponse = function (msg) {
        return {
            context,
            status: 400,
