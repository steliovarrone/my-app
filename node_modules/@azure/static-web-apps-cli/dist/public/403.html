...
<html lang="en">
  ...
  <body>
    ...
    <footer>
      <div>Azure Static Web Apps emulator (<a rel="noopener noreferrer" target="_blank" href="https://github.com/Azure/static-web-apps-cli/commit/38366e2">main+sha.38366e2</a>)</div>
      <nav>
        <ul>
